# @brief обычный класс ноды красно-черного дерева. то же самое, что и бинарное дерево поиска, только добавляется еще и понятие цвера вершины
class Node:
...
# @brief Самый обычный класс красно-черного дерева с реализацией всех необходимых алгоритмов балансировки.
class RedBlackTree:
